...
class ProductoList(APIView):
    ...
    def get(self,request):
        ...
        data = ProductoSerializer(prod,many=True,context={'request': request}).data #Luego se serializa todos los productos
...
class ProductoDetalle(APIView):
    ...
    def get(self,request, codigo): #para traer un producto.
        ...
        data = ProductoSerializer(prod,context={'request': request}).data
        return Response(data)
...
class ClienteList(APIView):
    ...
    def get(self,request):
        ...
        obj = filtrar_por_sucursal(Cliente.objects.all(), request, usar_filtro_pantalla=False)
